...
def main():
	...
	gbt_qc, DataSet = Make_GBT_QC_XML(gbt_qc, DataSet, testStatus, ADC_Reading, ELINKS, VFATS)

	gbt_sbit, DataSet = BuildRunCommonXML(xml_head, hw_info, test_conditions,"OH_GBT_SBIT","GE21 OH SBIT")
	gbt_sbit, DataSet = Make_GBT_SBIT_XML(gbt_sbit, DataSet, testStatus, ADC_Reading, ELINKS, VFATS)

	oh_qc, DataSet = BuildRunCommonXML(xml_head, hw_info, test_conditions,"OH_QC","GE21 OH QC Hardware")
	oh_qc, DataSet = Make_OH_QC_XML(oh_qc, DataSet, testStatus, ADC_Reading, ELINKS, VFATS)
